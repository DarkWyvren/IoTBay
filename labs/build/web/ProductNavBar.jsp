<%-- 
    Document   : ProductNavBar
    Created on : 07/06/2020, 10:17:18 AM
    Author     : antho
--%>
        ...
        <form action="Insert Search Controller Here" method="POST"  class="form-inline  bg-dark text-white">
            ...
            <div class="form-group p-2 mt-2">
                <div class="form-check ml-2 ">
                    <input class="form-check-input" type="button" value="" id="catagory1"  name="category_1">
            ...
            <div class="form-group p-2 ">
                <div class="form-check ml-2 ">
                    <input class="form-check-input" type="button" value="" id="catagory2"  name="category_2">
            ...
            <div class="form-group p-2 mb-2">
                <div class="form-check ml-2 ">
                    <input class="form-check-input" type="button" value="" id="catagory3"  name="category_3">
